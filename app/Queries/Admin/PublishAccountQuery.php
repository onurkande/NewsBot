...
class PublishAccountQuery
{
    ...
    {
        $columns = [
            ['label' => 'Kullanici Adi', 'key' => 'username'],
        ...
        return collect($columns)->map(function (array $column) use ($filters) {
            ...
            return [
                ...
                'url' => route('admin.publish-accounts.index', array_filter([
    ...
    private function normalizeFilters(array $filters): array
    {
        ...
        if (! in_array($sort, ['username', 'created_at'], true)) {
