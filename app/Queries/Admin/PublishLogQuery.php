...
class PublishLogQuery
{
    ...
    public function sortColumns(array $filters): array
    {
        $columns = [
            ...
            ['label' => 'Yayin Tarihi', 'key' => 'published_at'],
        ];
        ...
        return collect($columns)->map(function (array $column) use ($filters) {
            ...
            return [
                ...
                'url' => route('admin.publish-history.index', array_filter([
    ...
    private function normalizeFilters(array $filters): array
    {
        ...
        if (! in_array($filter, ['all', 'published', 'failed'], true)) {
            $filter = 'all';
        }
        if (! in_array($sort, ['created_at', 'published_at'], true)) {
